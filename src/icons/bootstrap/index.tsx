const BOOTSTRAP_URI = "https://icons.getbootstrap.com/assets/icons";

const DB_CHECK_ICON_URI = `${BOOTSTRAP_URI}/database-check.svg`;
const DB_X_ICON_URI = `${BOOTSTRAP_URI}/database-x.svg`;
