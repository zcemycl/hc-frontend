...
const AnnotationTypeDropdown = React.memo(
  ({
    queryType,
    setQueryType,
    ...
    const [isQueryTypeDropdownOpen, setIsQueryTypeDropdownOpen] =
      useState(false);
    return (
...
AnnotationTypeDropdown.displayName = "AnnotationTypeDropdown";
